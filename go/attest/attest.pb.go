...
const (
	...
	ZAttestReqType_ATTEST_REQ_QUOTE             ZAttestReqType = 3 // quote msg from device
...
type AttestKeyType int32

const (
	AttestKeyType_ATTEST_KEY_TYPE_INVALID AttestKeyType = 0 // Invalid key type
	AttestKeyType_ATTEST_KEY_TYPE_VSK     AttestKeyType = 1 // Volume Storage Key (VSK), for /persist/vault
)

// Enum value maps for AttestKeyType.
var (
	AttestKeyType_name = map[int32]string{
		0: "ATTEST_KEY_TYPE_INVALID",
		1: "ATTEST_KEY_TYPE_VSK",
	}
	AttestKeyType_value = map[string]int32{
		"ATTEST_KEY_TYPE_INVALID": 0,
		"ATTEST_KEY_TYPE_VSK":     1,
	}
)

func (x AttestKeyType) Enum() *AttestKeyType {
	p := new(AttestKeyType)
	*p = x
	return p
}

func (x AttestKeyType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (AttestKeyType) Descriptor() protoreflect.EnumDescriptor {
	return file_attest_attest_proto_enumTypes[6].Descriptor()
}

func (AttestKeyType) Type() protoreflect.EnumType {
	return &file_attest_attest_proto_enumTypes[6]
}

func (x AttestKeyType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use AttestKeyType.Descriptor instead.
func (AttestKeyType) EnumDescriptor() ([]byte, []int) {
	return file_attest_attest_proto_rawDescGZIP(), []int{6}
}

type AttestKeysResponseCode int32

const (
	AttestKeysResponseCode_ATTEST_KEYS_RESPONSE_CODE_INVALID         AttestKeysResponseCode = 0
	AttestKeysResponseCode_ATTEST_KEYS_RESPONSE_CODE_SUCCESS         AttestKeysResponseCode = 1 // key(s) successfully stored
	AttestKeysResponseCode_ATTEST_KEYS_RESPONSE_CODE_ITOKEN_MISMATCH AttestKeysResponseCode = 2 // integrity_token was not valid, try after successful attestation
)

// Enum value maps for AttestKeysResponseCode.
var (
	AttestKeysResponseCode_name = map[int32]string{
		0: "ATTEST_KEYS_RESPONSE_CODE_INVALID",
		1: "ATTEST_KEYS_RESPONSE_CODE_SUCCESS",
		2: "ATTEST_KEYS_RESPONSE_CODE_ITOKEN_MISMATCH",
	}
	AttestKeysResponseCode_value = map[string]int32{
		"ATTEST_KEYS_RESPONSE_CODE_INVALID":         0,
		"ATTEST_KEYS_RESPONSE_CODE_SUCCESS":         1,
		"ATTEST_KEYS_RESPONSE_CODE_ITOKEN_MISMATCH": 2,
	}
)

func (x AttestKeysResponseCode) Enum() *AttestKeysResponseCode {
	p := new(AttestKeysResponseCode)
	*p = x
	return p
}

func (x AttestKeysResponseCode) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (AttestKeysResponseCode) Descriptor() protoreflect.EnumDescriptor {
	return file_attest_attest_proto_enumTypes[7].Descriptor()
}

func (AttestKeysResponseCode) Type() protoreflect.EnumType {
	return &file_attest_attest_proto_enumTypes[7]
}

func (x AttestKeysResponseCode) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use AttestKeysResponseCode.Descriptor instead.
func (AttestKeysResponseCode) EnumDescriptor() ([]byte, []int) {
	return file_attest_attest_proto_rawDescGZIP(), []int{7}
}

//  This is the payload for a POST request to /api/v2/edgeDevice/id/<uuid>/attest
// The message is assumed to be encapsulated by AuthContainer.
type ZAttestReq struct {
	...
	StorageKeys *AttestKeys    `protobuf:"bytes,4,opt,name=storage_keys,json=storageKeys,proto3" json:"storage_keys,omitempty"`                 // encrypted secrets to be saved by the Controller, like encrypted keys for the volume storage (vaults)
}
...
func (x *ZAttestReq) GetStorageKeys() *AttestKeys {
	if x != nil {
...
//  This is the payload for a POST response to /api/v2/edgeDevice/id/<uuid>/attest
// The message is assumed to be encapsulated by AuthContainer.
type ZAttestResponse struct {
	...
	QuoteResp       *ZAttestQuoteResp `protobuf:"bytes,3,opt,name=quoteResp,proto3" json:"quoteResp,omitempty"`                                           // attest quote response from Controller, this can includes the encrypted keys
	StorageKeysResp *AttestKeysResp   `protobuf:"bytes,4,opt,name=storage_keys_resp,json=storageKeysResp,proto3" json:"storage_keys_resp,omitempty"`      // attest storage keys response from Controller
}
...
func (x *ZAttestResponse) GetStorageKeysResp() *AttestKeysResp {
	if x != nil {
...
type AttestKey struct {
	...
	KeyType AttestKeyType `protobuf:"varint,1,opt,name=key_type,json=keyType,proto3,enum=org.lfedge.eve.attest.AttestKeyType" json:"key_type,omitempty"`
	Key     []byte        `protobuf:"bytes,2,opt,name=key,proto3" json:"key,omitempty"`
}

func (x *AttestKey) Reset() {
	*x = AttestKey{}
	if protoimpl.UnsafeEnabled {
...
func (x *AttestKey) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AttestKey) ProtoMessage() {}

func (x *AttestKey) ProtoReflect() protoreflect.Message {
	mi := &file_attest_attest_proto_msgTypes[9]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AttestKey.ProtoReflect.Descriptor instead.
func (*AttestKey) Descriptor() ([]byte, []int) {
	return file_attest_attest_proto_rawDescGZIP(), []int{9}
}

func (x *AttestKey) GetKeyType() AttestKeyType {
	if x != nil {
		return x.KeyType
	}
...
// This is part of the ZAttestResponse, sent by the Controller to the device.
type ZAttestQuoteResp struct {
	...
	StorageKeys []*AttestKey `protobuf:"bytes,3,rep,name=storage_keys,json=storageKeys,proto3" json:"storage_keys,omitempty"` // Valid if response is ATTEST_RESPONSE_SUCCESS, contain keys (received encrypted
}
...
func (x *ZAttestQuoteResp) GetStorageKeys() []*AttestKey {
	if x != nil {
		return x.StorageKeys
	}
	return nil
...
type AttestKeys struct {
	...
	Keys           []*AttestKey `protobuf:"bytes,2,rep,name=keys,proto3" json:"keys,omitempty"`                                           // Encrypted keys for volume vault(s)
}

func (x *AttestKeys) Reset() {
	*x = AttestKeys{}
	if protoimpl.UnsafeEnabled {
...
func (x *AttestKeys) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AttestKeys) ProtoMessage() {}

func (x *AttestKeys) ProtoReflect() protoreflect.Message {
	mi := &file_attest_attest_proto_msgTypes[11]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AttestKeys.ProtoReflect.Descriptor instead.
func (*AttestKeys) Descriptor() ([]byte, []int) {
	return file_attest_attest_proto_rawDescGZIP(), []int{11}
}

func (x *AttestKeys) GetIntegrityToken() []byte {
	if x != nil {
		return x.IntegrityToken
	}
	return nil
...
func (x *AttestKeys) GetKeys() []*AttestKey {
	if x != nil {
		return x.Keys
	}
	return nil
...
type AttestKeysResp struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Response AttestKeysResponseCode `protobuf:"varint,1,opt,name=response,proto3,enum=org.lfedge.eve.attest.AttestKeysResponseCode" json:"response,omitempty"` // Result of processing Z_ATTEST_REQ_TYPE_STORE_KEYS in Controller
}

func (x *AttestKeysResp) Reset() {
	*x = AttestKeysResp{}
	if protoimpl.UnsafeEnabled {
...
func (x *AttestKeysResp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AttestKeysResp) ProtoMessage() {}

func (x *AttestKeysResp) ProtoReflect() protoreflect.Message {
	mi := &file_attest_attest_proto_msgTypes[12]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AttestKeysResp.ProtoReflect.Descriptor instead.
func (*AttestKeysResp) Descriptor() ([]byte, []int) {
	return file_attest_attest_proto_rawDescGZIP(), []int{12}
}

func (x *AttestKeysResp) GetResponse() AttestKeysResponseCode {
	if x != nil {
		return x.Response
	}
	return AttestKeysResponseCode_ATTEST_KEYS_RESPONSE_CODE_INVALID
}

type AttestKeyData struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	EncryptedKey []byte `protobuf:"bytes,1,opt,name=encrypted_key,json=encryptedKey,proto3" json:"encrypted_key,omitempty"` // key in encrypted format (encrypted with device wrapping key or KEK)
	DigestSha256 []byte `protobuf:"bytes,2,opt,name=digest_sha256,json=digestSha256,proto3" json:"digest_sha256,omitempty"` // SHA256 digest of the key
}

func (x *AttestKeyData) Reset() {
	*x = AttestKeyData{}
	if protoimpl.UnsafeEnabled {
...
func (x *AttestKeyData) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AttestKeyData) ProtoMessage() {}

func (x *AttestKeyData) ProtoReflect() protoreflect.Message {
	mi := &file_attest_attest_proto_msgTypes[13]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AttestKeyData.ProtoReflect.Descriptor instead.
func (*AttestKeyData) Descriptor() ([]byte, []int) {
	return file_attest_attest_proto_rawDescGZIP(), []int{13}
}

func (x *AttestKeyData) GetEncryptedKey() []byte {
	if x != nil {
...
var file_attest_attest_proto_rawDesc = []byte{
	...
	0x81, 0x02, 0x0a, 0x0a, 0x5a, 0x41, 0x74, 0x74, 0x65, 0x73, 0x74, 0x52, 0x65, 0x71, 0x12, 0x3f,
	...
	0x2e, 0x5a, 0x43, 0x65, 0x72, 0x74, 0x52, 0x05, 0x63, 0x65, 0x72, 0x74, 0x73, 0x12, 0x44, 0x0a,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x27, 0x0a, 0x0f, 0x69, 0x6e, 0x74, 0x65, 0x67, 0x72, 0x69,
	0x74, 0x79, 0x5f, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0e,
	0x69, 0x6e, 0x74, 0x65, 0x67, 0x72, 0x69, 0x74, 0x79, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x43,
	0x0a, 0x0c, 0x73, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x5f, 0x6b, 0x65, 0x79, 0x73, 0x18, 0x03,
	...
	,
	...
	,
}
...
var file_attest_attest_proto_goTypes = []interface{}{
	...
	(AttestKeyType)(0),           // 6: org.lfedge.eve.attest.AttestKeyType
	(AttestKeysResponseCode)(0),  // 7: org.lfedge.eve.attest.AttestKeysResponseCode
	...
	(*AttestKey)(nil),            // 17: org.lfedge.eve.attest.AttestKey
	(*ZAttestQuoteResp)(nil),     // 18: org.lfedge.eve.attest.ZAttestQuoteResp
	(*AttestKeys)(nil),           // 19: org.lfedge.eve.attest.AttestKeys
	(*AttestKeysResp)(nil),       // 20: org.lfedge.eve.attest.AttestKeysResp
	(*AttestKeyData)(nil),        // 21: org.lfedge.eve.attest.AttestKeyData
...
var file_attest_attest_proto_depIdxs = []int32{
	...
	19, // 3: org.lfedge.eve.attest.ZAttestReq.storage_keys:type_name -> org.lfedge.eve.attest.AttestKeys
	...
	20, // 7: org.lfedge.eve.attest.ZAttestResponse.storage_keys_resp:type_name -> org.lfedge.eve.attest.AttestKeysResp
	...
	6,  // 17: org.lfedge.eve.attest.AttestKey.key_type:type_name -> org.lfedge.eve.attest.AttestKeyType
	5,  // 18: org.lfedge.eve.attest.ZAttestQuoteResp.response:type_name -> org.lfedge.eve.attest.ZAttestResponseCode
	17, // 19: org.lfedge.eve.attest.ZAttestQuoteResp.storage_keys:type_name -> org.lfedge.eve.attest.AttestKey
	17, // 20: org.lfedge.eve.attest.AttestKeys.keys:type_name -> org.lfedge.eve.attest.AttestKey
	7,  // 21: org.lfedge.eve.attest.AttestKeysResp.response:type_name -> org.lfedge.eve.attest.AttestKeysResponseCode
